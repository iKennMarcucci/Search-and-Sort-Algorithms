...
# ALGORITMOS DE ORDENAMIENTO POR SHELL
def Shell(array):
...
Shell(numeros)
print()
print("ARRAY ORDENADO POR SHELL:")
print(numeros)
print()
print()

search = random.choice(numeros)
print('Valor a buscar en array ordenado por SHELL mediante BUSQUEDA LINEAL:', search)
busquedaLineal(numeros, search)
print()
print('Valor a buscar en array ordenado por SHELL mediante BUSQUEDA BINARIA:', search)
busquedaBinaria(numeros, search)
print()
print('Valor a buscar en array ordenado por SHELL mediante BUSQUEDA FIBONACCI:', search)
